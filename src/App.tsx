...
function CountdownSection() {
  const targetDate = React.useMemo(() => new Date('2026-09-14T18:00:00').getTime(), []);
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-theme-700 sm:text-lg">
            Every second brings us closer to our blessed wedding. We cannot wait to celebrate this grace-filled moment with you.
          </p>
        </motion.div>
...
const storyItems = [
  ...
  },
  {
    ...
    content: "Now we celebrate our wedding with the people we love. Thank you for being part of our story.",
    icon: PartyPopper,
    color: "#CBBF9F",
...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzxn2WByEUQsVQIhRvEJaf2bnG15MQyz528kBLMI9DngQh4obG72rq7_EbwG2atQByA/exec";
          ...
          >
            ...
            <section className="min-h-[100dvh] w-full flex items-center justify-center relative overflow-hidden bg-white">
              ...
              <div className="relative z-20 flex flex-col items-center text-center px-6 w-full max-w-[400px]">
                ...
                >
                  <p className="font-cinzel text-xl md:text-2xl text-theme-900 tracking-[0.3em] font-bold">14.09.2026</p>
                </motion.div>
                ...
                >
                  ...
                  <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16 text-center w-full max-w-5xl px-4">
                    ...
                    <div className="flex flex-col items-center flex-1">
                      ...
                      <p className="font-cinzel text-xl md:text-3xl text-theme-900 tracking-widest font-bold whitespace-nowrap">14.09.2026</p>
                    ...
                    <div className="flex flex-col items-center flex-1">
                      ...
                      <p className="text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] text-theme-600 font-bold mb-3">Time</p>
                ...
                <div className="max-w-2xl mx-auto">
                  ...
                  >
                      ...
                      <div className="space-y-4 relative pt-2 flex flex-col items-center">
                        <div className="pl-6 space-y-2">
                          <p className="text-theme-900 text-sm md:text-lg tracking-wide font-medium">
                            Barangay Maitim, Manila S Rd, Bay, 4033 Laguna, Philippines
                          </p>
                          <p className="text-theme-600 text-xs md:text-sm font-light max-w-md mx-auto">
                            Join us from 03:00 PM onwards to celebrate our special day.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="w-full flex justify-center">
                      <button
                        onClick={() => window.open('https://maps.app.goo.gl/KtKfG1yHnC6TsUZV6?g_st=ic', '_blank')}
                    ...
                    <div className="relative w-full aspect-[16/10] sm:aspect-[16/9] rounded-t-[100px] rounded-b-[2rem] shadow-[0_20px_45px_-10px_rgba(0,0,0,0.08)] border-[8px] border-white bg-theme-100 overflow-hidden group">
                      ...
                      <div className="absolute inset-0 w-full h-full scale-[1.1] group-hover:scale-[1.05] transition-transform duration-[2s]">
                        <iframe
                          src="https://maps.google.com/maps?q=D+Venue+Events+Place,+Bay,+Laguna&t=&z=14&ie=UTF8&iwloc=&output=embed"
                          width="100%"
                          height="100%"
                          style={{ border: 0 }}
                          allowFullScreen
